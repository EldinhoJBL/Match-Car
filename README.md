...
Aqui está o conteúdo completo para o seu ficheiro README.md. Este documento foi estruturado para destacar a robustez tecnológica do projeto e o impacto estratégico para a Wcar Veículos.

Pode copiar e colar o código abaixo diretamente no seu repositório do GitHub.
...
## 🔗 [Aceda à Aplicação em Produção aqui](https://seu-link-da-vercel.vercel.app)
...
* **Recomendação Preditiva:** Algoritmo que identifica a melhor opção de seminovo com base no perfil do comprador (Renda, Profissão, Idade).
* **Justificativa por IA:** Argumentos de venda personalizados gerados pelo Gemini AI para auxiliar os consultores.
* **Gestão de Stock Real-time:** Dashboard administrativo restrito para controlo total de ativos e monitorização de leads.
* **Interface Cliente Fluida:** Jornada do utilizador optimizada para captura de dados e conversão via WhatsApp.
...
* **Frontend & Interface:** React, TypeScript e Tailwind CSS (Desenvolvido via Lovable.dev).
* **Backend & Persistência:** Supabase (Base de dados PostgreSQL e Autenticação).
* **Infraestrutura:** Vercel (Hospedagem de alta performance).
* **Prototipagem:** Google Colab.
